...
export declare type OnNewFormState<FORM> = (newFormState: FormState<FORM>) => void;
export declare type OnFormStateChange<FORM> = (change: FormStateChange<FORM>) => void;
export declare type FormStateChange<T> = Partial<T>;
