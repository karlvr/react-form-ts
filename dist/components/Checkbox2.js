...
var Checkbox2 = /** @class */ (function (_super) {
    ...
    Checkbox2.prototype.render = function () {
        var _a = this.props, name = _a.name, formState = _a.formState, onFormStateChange = _a.onFormStateChange, onValue = _a.onValue, value = _a.value, rest = __rest(_a, ["name", "formState", "onFormStateChange", "onValue", "value"]);
    ...
    Checkbox2.prototype.shouldComponentUpdate = function (nextProps) {
